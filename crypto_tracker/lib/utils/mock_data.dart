...
List<TransactionModel> transactionHistory = [
  ...
  TransactionModel(timestamp: DateTime.utc(2022, 10, 4), assetType:AssetType.CRYPTOCURRENCY, amount:1100, transactionType:TransactionType.WITHDRAWL, statementType: StatementType.ASSET),
  ...
  TransactionModel(timestamp: DateTime.utc(2022, 8, 7), assetType:AssetType.CRYPTOCURRENCY, amount:1100, transactionType:TransactionType.WITHDRAWL, statementType: StatementType.ASSET),
